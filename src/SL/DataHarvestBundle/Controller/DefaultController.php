...
class DefaultController extends Controller
{
    ...
    private function _harvestTROVE()
    {
        $params = array(
            'paths' => array(
                "key=***REMOVED***&q={$this->_searchTerm} date:[1910 TO 1920]&zone=newspaper&include=tags,workversions&reclevel=full&l-title=35",
                "key=***REMOVED***&q={$this->_searchTerm} date:[1910 TO 1920]&zone=newspaper&include=tags,workversions&reclevel=full&l-title=1007",
            ),
            'max' => 100,
        );
        $output = '';
